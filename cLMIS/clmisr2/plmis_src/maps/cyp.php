...
<SCRIPT LANGUAGE="Javascript" SRC="../../plmis_js/maps/cyp.js"></SCRIPT>
<SCRIPT LANGUAGE="Javascript" SRC="../../plmis_js/maps/IntervalLegend.js"></SCRIPT>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">Couple Year Protection Map </h3>
                        <div class="widget" data-toggle="collapse-widget">
                            <div class="widget-head">
                                <h3 class="heading">Filter by</h3>
                            </div>
                            <div class="widget-body">
                                <?php include(PLMIS_INC. "maps/cypForm.php"); ?>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="widget" data-toggle="collapse-widget">
                                <div class="widget-head">
                                    <h3 class="heading">CYP Status</h3>
                                </div>
                                <div class="widget-body">
                                    <div id="pie"></div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="widget" data-toggle="collapse-widget">
                                <div class="widget-head">
                                    <h3 class="heading">District wise CYP Ranking</h3>
                                </div>
                                <div class="widget-body">
                        ...
                        <div class="col-md-6">
                            <div class="widget" data-toggle="collapse-widget">
                                <div class="widget-head">
                                    <h3 class="heading">District wise CYP Status</h3>
                                </div>
                                <div class="widget-body">
