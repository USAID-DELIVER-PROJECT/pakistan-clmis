...
//////////// GET Province/Region Name
	$provinceQryRes = mysql_fetch_array(mysql_query("SELECT LocName FROM tbl_locations WHERE PkLocID = '".$sel_prov."' "));
...
<body class="page-header-fixed page-quick-sidebar-over-content" text="#000000" bgColor="#FFFFFF" style="margin-left:0px;margin-top:0px,margin-right:0px;margin-bottom:0px; overflow:visible;" onLoad="doInitGrid();showstkHolders();">
                        ...
                        <table width="99%">
                            ...
                            <tr>
                                <td class="sb1NormalFont">
                                    ...
                                    <select onChange="mygrid.setSkin(this.value)" class="form-control input-small input-sm">
