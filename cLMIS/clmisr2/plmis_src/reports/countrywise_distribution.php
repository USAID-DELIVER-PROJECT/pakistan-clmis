...
if ($_REQUEST['submit'])
{
	...
	$qry = "SELECT
				...
				ROUND((SUM(ABS(tbl_stock_detail.Qty)) / itminfo_tab.qty_carton)) AS Cartons,
...
<script>
	...
	function doInitGrid(){
		...
		mygrid.setHeader("<div style='text-align:center;'><?php echo "Contraceptive Distribution Report for Province/Region = '$provName' District = '$distName' Stakeholder = '$stkName' Product = '$itmName' From '$dateFrom' To '$dateTo'";?></div>,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan,#cspan");
                              ...
                              <form name="frm" id="frm" action="" method="post" role="form">
                                  <table id="myTable">
                                      <tr>
                                          ...
                                          <td class="col-md-2" id="districts">
                                      ...
                                      <tr>
                                          <td class="col-md-2">
                                              ...
                                              <input name="from_date" id="from_date" class="form-control input-sm" readonly value="<?php echo $dateFrom;?>" />
                                          </td>
                                          <td class="col-md-2">
                                              <label class="control-label">Date To</label>
                                              <input name="to_date" id="to_date" class="form-control input-sm" readonly value="<?php echo $dateTo;?>" />
                                          </td>
                                          <td class="col-md-2">
                                              <label class="control-label">Transportation Mode</label>
