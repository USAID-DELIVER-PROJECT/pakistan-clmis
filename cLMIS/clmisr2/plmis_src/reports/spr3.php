...
if (isset($_POST['submit'])) {
    ...
    $qtrArr[1] = array('01-01', '03-31');
    $qtrArr[2] = array('04-01', '06-30');
    $qtrArr[3] = array('07-01', '09-30');
    $qtrArr[4] = array('10-01', '12-31');
    $qtrArr[5] = array('01-01', '06-31');
    $qtrArr[6] = array('07-01', '12-31');
    $qtrArr[7] = array('01-01', '12-31');
    $startDate = $selYear . '-' . $qtrArr[$qtr][0];
    $endDate = $selYear . '-' . $qtrArr[$qtr][1];
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="page-title row-br-b-wp">Quarter Wise Provincial Summary of Contraceptive Performance</h3>
