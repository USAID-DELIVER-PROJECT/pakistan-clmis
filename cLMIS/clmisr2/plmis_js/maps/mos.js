...
function drawFeature() {
    ...
    $.ajax({
        url: "../../plmis_src/api/get-c-mos-map-data.php",
        type: "GET",
        data: {
            year: year,
            month: month,
...
function lastMonthsStats(district_id, district_name) {
    ...
    $("#graph").html("");
    $.ajax({
        url: "../../plmis_src/api/get-district-chart.php",
        type: "GET",
        data: {
            year: year,
            month: month,
    ...
    var revenueChart = new FusionCharts({
        ...
        dataSource: {
            "chart": {
                ...
                "exportEnabled": "1",
                "theme": "fint",
                "palettecolors": "'" + classesArray[0].color_code + "," + classesArray[1].color_code + "," + classesArray[2].color_code + "," + classesArray[3].color_code + "," + classesArray[4].color_code + "," + classesArray[5].color_code + "'"
            },
            "data": pieArray
        }
    });
