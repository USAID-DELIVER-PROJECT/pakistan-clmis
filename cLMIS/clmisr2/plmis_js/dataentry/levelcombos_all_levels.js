...
function showCombos3()
{
	...
	$.ajax({
		type: "POST",
		url: basePath+"plmis_admin/levelcombos2_all_levels_action.php",
...
function showCombos2()
{
	if ( $('#office').val() > 1 )
	{
		...
		$.ajax({
			type: "POST",
			url: basePath+"plmis_admin/levelcombos1_all_levels_action.php",
...
function showCombos()
{
	...
	$.ajax({
		type: "POST",
		url: basePath+"plmis_admin/levelcombos_all_levels_action.php",
