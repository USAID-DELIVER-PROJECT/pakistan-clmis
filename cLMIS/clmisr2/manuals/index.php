            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#tab_1_1">Contraceptives</a></li>
                        <li class=""><a data-toggle="tab" href="#tab_1_2">Courses</a></li>
                        <li class=""><a data-toggle="tab" href="#tab_1_3">Logistics</a></li>
                    </ul>
