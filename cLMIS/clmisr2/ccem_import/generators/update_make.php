...
if (isset($_REQUEST['lmisName']) && isset($_REQUEST['ccemName'])) {
    $qry = "UPDATE import_generators
			...
			WHERE
				import_generators.ft_manu_name = '" . $_REQUEST['ccemName'] . "'";
    mysql_query($qry);
    exit;
}

// Update Makes
mysql_query("UPDATE import_generators,
            ccm_makes
            SET import_generators.MakeID = ccm_makes.pk_id
            WHERE
                import_generators.ft_manu_name = ccm_makes.ccm_make_name");
?>
        ...
        <table id="myTable" width="700">
            ...
            <tbody>
                ...
                $ccmQry = "SELECT DISTINCT
                                ...
                                import_generators.ft_manu_name
                            FROM
                                import_generators";
...
<a href="energy_source.php">Next</a>