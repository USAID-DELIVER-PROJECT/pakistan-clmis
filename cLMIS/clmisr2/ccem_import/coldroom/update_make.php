...
if (isset($_REQUEST['lmisName']) && isset($_REQUEST['ccemName']))
{
	$qry = "UPDATE import_cold_room
			...
			WHERE
				import_cold_room.ft_manu_name = '".$_REQUEST['ccemName']."'";
	mysql_query($qry);
	exit;
}

// Update Makes
mysql_query("UPDATE import_cold_room,
				 ccm_makes
				SET import_cold_room.MakeID = ccm_makes.pk_id
				WHERE
					import_cold_room.ft_manu_name = ccm_makes.ccm_make_name");
?>
...
<body>
	<h3>Update Makes of cold room</h3>
