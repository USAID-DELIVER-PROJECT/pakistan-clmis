...
<table width="100%">
    ...
    <select name="prov_sel" id="prov_sel" class="form-control input-sm">
        ...
        <td class="col-md-2"><label class="control-label">Level</label>
            <select name="level_sel" id="level_sel" class="form-control input-sm">
                <option value="all">District + Field </option>
