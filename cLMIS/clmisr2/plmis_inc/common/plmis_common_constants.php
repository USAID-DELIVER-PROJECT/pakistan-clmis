...
{
	define('PLMIS_SUGAR_ROOT','http://localhost/lmisnew/');
	define('PLMIS_SUGAR_CONTROL',false);
	define('PLMIS_INC_BASE','../../'); //
}


define("PLMIS_LOGO_TEXT", 'Pakistan Logistics Management Information System');  // couldn't find based on look-up options 
