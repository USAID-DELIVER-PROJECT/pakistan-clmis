<?php/* * Filename:       assets/plugins/fckeditor242/lang/spanish.inc.php * Function:       Spanish language file for FCKEditor.  Needs to be translated! * Encoding:       ISO-Latin-1 * Author:         Jeff Whitfield * Date:           2007/05/08
 * Version:        2.4.2
 * MODx version:   0.9.5*/include_once(dirname(__FILE__).'/english.inc.php'); // fallback for missing defaults or new additions$_lang['FCKEditor_settings'] = "FCKEditor Settings";
