<?php
/**
 * Filename:       assets/plugins/fckeditor242/lang/simple_chinese.inc.php
 * Function:       Simple Chinese language file for FCKEditor.  Needs to be translated and re-encoded!
