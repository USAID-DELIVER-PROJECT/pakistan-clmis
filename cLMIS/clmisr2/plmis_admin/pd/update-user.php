...
require_once("db.php");
$user_Id = $_GET['user'];
$strSql = "Select sysusr_email as email,sysusr_addr as address,sysusr_cell as phoneNo ,sysusr_name as realName,sysusr_deg as designation from sysuser_tab where UserID=$user_Id";
...
<html> 
    <body>
        ...
        <form action="action.php?action=update" method="post" id="update-user" >
            <table>
                <tr>
                    <td>Full Name</td>
                    <td>
