...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <table width="1000px" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
                <td align="center" bgcolor="#78B82E"><img src="<?php echo ADMIN_IMAGES.'adminheader.jpg';?>" alt="" width="1002"/></td>
            </tr>
            <tr>
                <td><?php
                    //include("header.php");
            ...
            <tr>
                <td valign="top"><table width="100%" height="146" valign="top">
                        ...
                        if (isset($_POST['wh_id']) || isset($_GET['hash'])) {
                            ...
                            ?>
                        <tr>
                        <td width="80%" bgcolor="#E1E1E1"><table width="100%" border="1">
                                <tr>
                                <td><?php echo "Year";?></td>
                                <?php
                                            for ($i = 1; $i <= 12; $i++) 
											{
                                            ?>
                                <td><?php echo $arrMonths[$i]; ?></td>
                                <?php
                                            }
                                            ?>
                            </tr>
                                <?php
    $qry = "SELECT report_year FROM tbl_wh_data GROUP BY report_year";
    ...
    while ($rsrows = mysql_fetch_array($rsYears)) {
        ...
        ?>
                                ...
                                <?php
                                            for ($i = 1; $i <= 12; $i++) {
                                                ...
                                                if ($i == $mrows['report_month']) {
                                                    ?>
                                <td <?php if($year == $yy && $mm == $i) { ?> class="active" <?php } ?>><a href="data_entry_admin.php?hash=<?php echo $url; ?>"><?php echo $arrMonths[$i]; ?></a></td>
                                <?php
                                                    } else {
                                ...
                                <td></td>
                                <?php } else { ?>
                                <td <?php if($year == $yy && $mm == $i) { ?> class="active" <?php } ?>><a href="data_entry_admin.php?hash=<?php echo $url; ?>" style="color: #ff0000;">Add</a></td>
                                <?php
                                                        }
                                                    }
                                                }
                        ...
                        <tr>
                        <td><span style="color:rgb(0, 103, 0)">Month Name</span> = Data is available<br/>
                                <span style="color: #ff0000;">Add</span> = Data is not available but you can add it.</td>
                    </tr>
                        <?php
                                    }
                                        ?>
