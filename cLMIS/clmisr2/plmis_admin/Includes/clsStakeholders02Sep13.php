...
class clsStakeholder
{
	...
	{
		if ($this->m_stkname=='') $this->m_stkname='NULL';
		if ($this->m_stkorder=='') $this->m_stkorder='NULL';
		if ($this->m_ParentID=='') $this->m_ParentID='NULL';
		if ($this->m_stk_type_id=='') $this->m_stk_type_id=0;
		if ($this->m_lvl=='') $this->m_lvl=1;
		if ($this->m_MainStakeholder=='') $this->m_MainStakeholder='NULL';
