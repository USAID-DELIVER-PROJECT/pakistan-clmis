...
<style>
	...
	input, button.btn-primary, button.btn-danger, select{height:25px !important; padding-top:0px; padding:3px !important; font-size:12px !important;}
</style>
</head>
<!-- END HEAD -->
                    ...
                    <div class="col-md-12"><!-- Content -->
                        ...
                        <div class="row">
                            <div class="col-md-12 right" style="padding:5px 15px;">
                                <button onClick="window.location = 'placement_locations.php?<?php echo 'area=' . $_REQUEST['area'] . '&level=' . $_REQUEST['level']; ?>'" class="btn btn-primary"> Back to Locations </button>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-head">
                                ...
                                <h3 class="heading">
                                    Stock placed at <?php echo $rowLocation['location_name'] ?>
                                </h3>
                                        ...
                                        while ($rowStock = mysql_fetch_assoc($getStock)) {
                                            if ($rowStock['quantity'] > 0) {
                                                ...
                                                <tr class="gradeX">
                                                    ...
                                                    <td>
                                                        <form name="transfer_stock" method="post" id="transfer_stock" action="transfer_stock_action.php" onSubmit="disableButton(this.form, '<?php echo $submitBtnId; ?>')">
                                                            ...
                                                            <button type="button" id="del_<?php echo $submitBtnId; ?>" name="delete" value="delete" class="btn btn-danger" style="float:right" onClick="deletePlacement(<?php echo $loc_id;?>, <?php echo $rowStock['batch_id'];?>);">Delete</button>
                                                            <button type="submit" id="<?php echo $submitBtnId; ?>" name="save" value="submit" class="btn btn-primary" style="float:right">Save</button>
