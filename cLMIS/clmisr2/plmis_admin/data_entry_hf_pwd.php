        ...
        <td valign="top"><table width="100%" height="146" valign="top">
                <tr>
					...
					if(isset($_REQUEST['Do']) && !empty($_REQUEST['Do']))
					{
						...
						print "<b>Store/Facility:</b> ".$whName;
						...
						?>
                        <FORM NAME="frmF7" id="frmF7" ACTION="data_entry_hf_pwd_action.php" METHOD="POST" ENCTYPE="MULTIPART/FORM-DATA" onSubmit="return formvalidate1();">
							...
							?>
								...
								?>
                            	<TR>
                                    <TD CLASS="sb1GeenGradientBoxMiddle" colspan="3" align="left">Total Number of Centers for <?php echo $whName;?></TD>
                                </TR>
                                <TR>
                                    <TD colspan="3" style="text-align:left;" CLASS="TDLCOLRASMALLW">
                                    	<input type="text" class="TextBoxSmallRA" name="total_hf" id="total_hf" value="<?php echo (!empty($totalHf)) ? $totalHf : 0 ;?>" autocomplete="off" />
                                    </TD>
                                </TR>
                                <?php }?>
                                <TR>
