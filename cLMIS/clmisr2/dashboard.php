...
<?php include "plmis_inc/common/top_im.php";?>
    ...
    <div class="page-content-wrapper">
                        ...
                        <div id='map'>
                            ...
                            <div id='inputForm'>
                                <table>
                                    <tr>
                                        <td>
                                            <select name="stk_sel" id="stk_sel" class="form-control input-small input-sm" style="width:50px">           
                                            <?php
                                            $querystk = "SELECT stkid,stkname FROM stakeholder Where ParentID is null AND stk_type_id IN (0) order by stkorder";
                                        ...
                                        <td>
                                            <?php $sel_item = 'IT-001'; ?>
                                            <select name="prod_sel" id="prod_sel" class="form-control input-small input-sm" style="width:50px">
		...
		{
			echo "<script>window.location='dashboard/shipment.php'</script>";
		}
		?>
    </div>
</div>
