...
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        ...
        <link href="<?php echo SITE_URL; ?>assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css" rel="stylesheet" type="text/css"/>
        ...
        <link href="<?php echo SITE_URL; ?>assets/frontend/layout/css/style.css" rel="stylesheet" type="text/css"/>
...
<div class="header navbar bgImg">
    ...
    <div class="header-inner ">
        ...
        <a class="navbar-brand" href="index.php">
            <img src="<?php echo SITE_URL; ?>assets/img/landing-images/contraceptives-images/main_logo.png" height="63" width="327" alt="vaccine LMIS" />
        </a>
        <!-- END LOGO -->
        <!-- BEGIN RESPONSIVE MENU TOGGLER -->
        <a href="javascript:;" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            <img src="<?php echo SITE_URL; ?>assets/img/menu-toggler.png" alt=""/>
        </a>
