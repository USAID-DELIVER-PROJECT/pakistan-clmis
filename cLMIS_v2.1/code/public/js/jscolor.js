...
var jscolor = {
				...
				if(r.authority !== null) {
					...
					if(r.path === '') { // == or === ?
						...
						if(r.path.substr(0,1) === '/') {
							...
							if(base.authority !== null && base.path === '') { //  == or === ?
								t.path = '/'+r.path;
							} else {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			p.padM.style.backgroundImage = "url('"+jscolor.getDir()+"cross1.gif')";
		...
		jscolor.requireImage('../../plmis_img/cross1.gif');
		jscolor.requireImage('../../plmis_img/arrow.gif');
