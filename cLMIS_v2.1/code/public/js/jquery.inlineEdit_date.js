    ...
    $.inlineEdit = function (urls, options) {
        ...
        $('.editableSingle').click(function () {
            ...
            if (!editableFields || $('.editField').length < editableFields) {
                ...
                if ($('.editFieldFirst').length == 0) {
                    ...
                    $(this).html('<div class="editFieldWrapper"><input type="text" id="datepickeredit" readonly="true" value="' + value + '" class="form-control editField editFieldFirst span2" style="width:110px" /></div>');
                    if (!simpleMode) {
                    ...
                    addSaveControllers(function () {
                        ...
                        $('.editFieldFirst').focusout();
                        $('.editFieldFirst').focus();
                    });
                } else {
                    $(this).html('<div class="editFieldWrapper"><input type="text" value="' + value + '" class="editField span2" /></div>');
                }
            }
        });
        ...
        function addSaveControllers(callback)
        {
            if ($('.editFieldWrapper:last').parent().hasClass('removable')) {
                $('.editFieldWrapper:last').append('<div class="editFieldSaveControllers"><button class="btn btn-primary btn-mini">Save</button>' +
                        ', <a href="javascript:;" class="editFieldRemove">Remove</a> or ' +
                        '<a href="javascript:;" class="editFieldCancel"><button class="btn btn-warning btn-mini">Cancel</button></a></div>');
            } else {
                $('.editFieldWrapper:last').append('<div class="editFieldSaveControllers"><button class="btn btn-primary btn-mini">Save</button> or ' +
                        '<a href="javascript:;" class="editFieldCancel"><button class="btn btn-warning btn-mini">Cancel</button></a></div>');
            }
