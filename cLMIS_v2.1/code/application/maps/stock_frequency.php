...
<SCRIPT LANGUAGE="Javascript" SRC="<?php echo PUBLIC_URL;?>js/maps/stockFrequency.js"></SCRIPT>
...
<div class="page-content-wrapper">
    <div class="page-content">
        <div class="row">
            <div class="col-md-12">
                <h3 class="page-title row-br-b-wp">Stock Out Frequency Map</h3>
                <div class="widget" data-toggle="collapse-widget">
                    <div class="widget-head">
                        <h3 class="heading">Filter by</h3>
                    </div>
                    <div class="widget-body">
                        <?php include(APP_PATH."includes/maps/stockFrequencyForm.php"); ?>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    ...
                    <div class="widget" data-toggle="collapse-widget">
                        <div class="widget-head">
                            <h3 class="heading">Stock Out Frequency Status</h3>
                        </div>
                        <div class="widget-body">
                            <div id="pie"></div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    <div class="widget" data-toggle="collapse-widget">
                        <div class="widget-head">
                            <h3 class="heading">Stock Out Frequency Ranking</h3>
                        </div>
                        <div class="widget-body">
                ...
                <div class="col-md-6">
                    <div class="widget" data-toggle="collapse-widget">
                        <div class="widget-head">
                            <h3 class="heading">District Wise Stock Out Frequency Status</h3>
                        </div>
                        <div class="widget-body">
