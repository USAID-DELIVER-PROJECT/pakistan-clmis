...
<SCRIPT LANGUAGE="Javascript" SRC="<?php echo PUBLIC_URL;?>js/maps/mos.js"></SCRIPT>
            ...
            <div class="col-md-12">
                ...
                <div class="widget" data-toggle="collapse-widget">
                    ...
                    <div class="widget-body">
                        <?php include(APP_PATH."includes/maps/mosForm.php"); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <ul class="nav nav-tabs">
                        ...
                        <li class=""> <a data-toggle="tab" href="#tab-2">MOS Scale</a> </li>
                    </ul>
